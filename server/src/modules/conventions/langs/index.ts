 ...
 * here — see docs/go-language-support-plan.md Phase 7.1. Not yet keyed off
 * `repo-intel/languages/index.ts`'s `LANGUAGES` array directly (config
 ...
 */
export const CONVENTION_LANG_PACKS: readonly ConventionLangPack[] = [typescriptPack];
